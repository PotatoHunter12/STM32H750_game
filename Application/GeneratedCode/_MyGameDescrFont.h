...
EW_DEFINE_FONT_RES( MyGameDescrFont, 13, 3, 0, 16, 0x00C0, 0x00C0 )
  EW_GLYPH( 0x0000, 1, -9, 8, 9, 8, 0x00000000 ),
  ...
  EW_FONT_PIXEL( MyGameDescrFont, 0x00008BB5 )                  /* ratio 80.19 % */
  ...
  EW_FONT_KERNING_CODES( MyGameDescrFont )
  EW_FONT_KERNING_VALUES( MyGameDescrFont )
EW_END_OF_FONT_RES( MyGameDescrFont )
