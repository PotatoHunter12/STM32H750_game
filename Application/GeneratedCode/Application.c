...
void ApplicationApplication__Init( ApplicationApplication _this, XObject aLink, XHandle aArg )
{
  ...
  MyGameGame__Init( &_this->MyGame, &_this->_.XObject, 0 );
  ...
  CoreRectView__OnSetBounds( &_this->MyGame, _Const0000 );
  CoreGroup_Add((CoreGroup)_this, ((CoreView)&_this->MyGame ), 0 );
}
...
void ApplicationApplication__ReInit( ApplicationApplication _this )
{
  ...
  MyGameGame__ReInit( &_this->MyGame );
}
...
EW_DEFINE_CLASS( ApplicationApplication, CoreRoot, MyGame, _.VMT, _.VMT, _.VMT, 
